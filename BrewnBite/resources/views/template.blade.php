    ...
    <div class="flex items-center space-x-4">
        ...
        <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg w-auto border border-gray-200 shadow-xl">
            <div class="px-4 py-3 text-sm text-gray-700">
                ...
                @php
                    $totalSpent = session('user.total_spent', 0);
                    $membership = 'Bronze';
                ...
                @endphp
                <div class="rounded-xl shadow-md p-2 my-2 {{
...
<footer class="relative bg-gradient-to-br from-emerald-500 to-red-200">
    <div class="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div class="mb-8 ">
            <div class="flex justify-center items-center flex-col">
                <h1 class="font-semibold text-2xl text-white ml-2">Brew & Bite</h1>
                <p class="mt-4 text-sm text-white">
                    At Brew & Bite, we're passionate about delivering the finest coffee and bites to satisfy your cravings.
                </p>
            </div>
        </div>
