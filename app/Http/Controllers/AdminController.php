...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('admin.dashboard', ['user' => $user, 'dtrans' => $dtrans, 'ingredients' => $ingredients, 'topspenders' => $topspenders, 'sales' => $sales, 'total_sales' => $total_sales, 'percentageChange' => $percentageChange]);
    }
